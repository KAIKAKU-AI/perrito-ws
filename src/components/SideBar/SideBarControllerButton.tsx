...
const SideBarControllerButton = (props: SideBarControllerButtonProps) => {
  ...
  return (
    <button className="sidebar-controller__button" onClick={props.onClick}>
      <div
        className={`sidebar-controller__button-top ${defaultTopRotationClass} ${hoverTopRotationClass}`}
      ></div>
      <div
        className={`sidebar-controller__button-bottom ${defaultBottomRotationClass} ${hoverBottomRotationClass}`}
      ></div>
    </button>
  );
};
